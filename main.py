...
def update_color():
    ...
    # Make the current color box smaller than the original due to ipadx on the original color box
    ...
    # Display the HEX and tuple value of the given color
...
def store_color():
    ...
    recall_button = Button(output_frame, text="Recall Color",
...
stored_color = StringVar()
stored_colors = {}

color_tuple = Label(input_frame, text="(0,0,0)")
color_tuple.grid(row=3, column=2)
...
for i in range(6):
    ...
    recall_button.grid(row=i, column=1, padx=10)
    new_color_tuple.grid(row=i, column=2, padx=10)
    new_color_hex.grid(row=i, column=3, padx=10)
